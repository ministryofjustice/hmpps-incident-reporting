...
export const types = [
  ...
  { familyCode: 'BARRICADE', code: 'BARRICADE_1', description: 'Barricade', active: false, nomisCode: 'BARRICADE' },
  {
    ...
    description: 'Disruption to 3rd party supplier - Business Continuity',
    active: false,
  ...
  },
  {
    ...
    description: 'Loss of Access / Egress  - Business Continuity',
    active: false,
  ...
  },
  {
    ...
    description: 'Loss of Utilities - Business Continuity',
    active: false,
  ...
  },
  {
    ...
    description: 'Severe Weather - Business Continuity',
    active: false,
  ...
  },
  {
    ...
    description: 'Staff shortages  - Business Continuity',
    active: false,
  ...
  },
  {
    ...
    description: 'Widespread illness - Business Continuity',
    active: false,
...
export const typesDescriptions: Record<Type, string> = {
  ...
  BC_DISRUPT_3RD_PTY_1: 'Disruption to 3rd party supplier - Business Continuity',
  BC_FUEL_SHORTAGE_1: 'Fuel Shortage - Business Continuity',
  BC_LOSS_ACCESS_EGRESS_1: 'Loss of Access / Egress  - Business Continuity',
  BC_LOSS_COMMS_1: 'Loss of Communications & Digital Systems - Business Continuity',
  BC_LOSS_UTILS_1: 'Loss of Utilities - Business Continuity',
  BC_SERV_WEATHER_1: 'Severe Weather - Business Continuity',
  BC_STAFF_SHORTAGES_1: 'Staff shortages  - Business Continuity',
  BC_WIDESPREAD_ILLNESS_1: 'Widespread illness - Business Continuity',

 ...
 * NB: this was recreated manually and remains incomplete! For example, no concrete component classes are included
 */
...
declare module 'govuk-frontend/dist/govuk/govuk-frontend-component' {
  ...
  > {
    ...
    static elementType: new () => RootElementType
...
declare module 'govuk-frontend/dist/govuk/common/configuration' {
  ...
  type ObjectNested = Record<string, string, string | boolean | number | ObjectNested | undefined>

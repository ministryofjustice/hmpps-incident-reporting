...
export const types = {
  ...
  ASSAULT_1: { familyCode: 'ASSAULT', description: 'Assault', active: false, nomisCode: 'ASSAULT' },
  ASSAULT_2: { familyCode: 'ASSAULT', description: 'Assault', active: false, nomisCode: 'ASSAULTS' },
  ASSAULT_3: { familyCode: 'ASSAULT', description: 'Assault', active: false, nomisCode: 'ASSAULTS1' },
  ASSAULT_4: { familyCode: 'ASSAULT', description: 'Assault', active: false, nomisCode: 'ASSAULTS2' },
  ASSAULT_5: {
    familyCode: 'ASSAULT',
    description: 'Assault',
    active: true,
  ...
  BARRICADE_1: { familyCode: 'BARRICADE', description: 'Barricade', active: false, nomisCode: 'BARRICADE' },
  ...
  DAMAGE_1: { familyCode: 'DAMAGE', description: 'Deliberate damage', active: false, nomisCode: 'DAMAGE' },
  DEATH_PRISONER_1: {
  ...
  FIND_1: { familyCode: 'FIND', description: 'Find of illicit items', active: false, nomisCode: 'FINDS' },
  FIND_2: { familyCode: 'FIND', description: 'Find of illicit items', active: false, nomisCode: 'FIND' },
  FIND_3: { familyCode: 'FIND', description: 'Find of illicit items', active: false, nomisCode: 'FIND1' },
  FIND_4: { familyCode: 'FIND', description: 'Find of illicit items', active: false, nomisCode: 'FIND0322' },
  FIND_5: { familyCode: 'FIND', description: 'Find of illicit items', active: false, nomisCode: 'FINDS1' },
  FIND_6: {
    familyCode: 'FIND',
  ...
  HOSTAGE_1: { familyCode: 'HOSTAGE', description: 'Hostage incident', active: false, nomisCode: 'HOSTAGE' },

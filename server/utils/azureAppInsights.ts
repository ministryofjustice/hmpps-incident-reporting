...
export function ignoredRequestsProcessor(envelope: EnvelopeTelemetry): boolean {
...
export function ignoredDependenciesProcessor(envelope: EnvelopeTelemetry): boolean {
